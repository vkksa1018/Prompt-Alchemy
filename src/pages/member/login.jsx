  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0A0E1A]/85 backdrop-blur-md p-4">
      <form
        ...
        className="box-border w-full max-w-[440px] shrink-0 h-fit [box-shadow:0px_0px_40px_0px_#39FF1420] flex flex-col gap-[20px] p-[32px] justify-start items-start bg-[#111827] border border-[#39FF14] rounded-[24px]"
      >
        <div
        ...
        >
          ...
          <input
            ...
            required
            className="box-border w-full h-fit shrink-0 p-[14px] bg-[#0F1F18] border border-[#1A3A2A] rounded-[12px] text-[14px] text-[#E0F0E8] placeholder-[#3D6B50] focus:outline-none focus:border-[#39FF14] font-['JetBrains_Mono',system-ui,sans-serif] transition-all"
          />
        </div>
        ...
        >
          ...
          <div className="box-border w-full h-fit shrink-0 relative">
            <input
              ...
              placeholder="••••••••••"
              required
              className="box-border w-full h-fit shrink-0 p-[14px] pr-[44px] bg-[#0F1F18] border border-[#1A3A2A] rounded-[12px] text-[14px] text-[#E0F0E8] placeholder-[#3D6B50] focus:outline-none focus:border-[#39FF14] font-['JetBrains_Mono',system-ui,sans-serif] transition-all"
            />
            <button
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              data-pencil-name="Password Toggle"
              className="absolute right-[14px] top-[15px] text-[16px]/[normal] box-border text-[#7DCEA0] hover:text-[#39FF14] font-['JetBrains_Mono',system-ui,sans-serif] font-normal bg-transparent border-none cursor-pointer focus:outline-none transition-colors"
            >
              👁
            </button>
          </div>
        ...
        >
          <button
            ...
            className="box-border w-fit shrink-0 h-fit flex flex-row gap-[10px] justify-start items-center bg-transparent border-none cursor-pointer focus:outline-none"
          >
            <div
              data-pencil-name="Remember Check"
              className={`box-border w-[14px] shrink-0 h-[14px] rounded-full border transition-all ${
                rememberMe ? "bg-[#39FF14] border-[#39FF14]" : "bg-transparent border-[#3D6B50]"
              }`}
            ></div>
            <div
        ...
        <button
          ...
          className="box-border w-full h-fit shrink-0 flex flex-row gap-0 p-[14px] justify-center items-center bg-[#39FF14] hover:bg-[#39FF14]/90 active:scale-[0.98] transition-all rounded-[12px] border-none cursor-pointer"
        >
          <div
        ...
        >
          <div
            ...
            className="box-border flex-1 h-[1px] bg-[#1A3A2A]"
          ></div>
          <div
        ...
        <button
          ...
          className="box-border w-full h-fit shrink-0 flex flex-row gap-[10px] p-[14px] justify-center items-center bg-transparent hover:bg-[#1A3A2A]/20 transition-all border border-[#1A3A2A] rounded-[12px] cursor-pointer"
        >
          <div
        ...
        >
          ...
          <div
            ...
            className="text-[13px]/[normal] box-border text-[#39FF14] hover:text-[#39FF14]/80 transition-all cursor-pointer font-['JetBrains_Mono',system-ui,sans-serif] font-semibold text-left whitespace-nowrap"
          >
            立即註冊
          </div>
        </div>
