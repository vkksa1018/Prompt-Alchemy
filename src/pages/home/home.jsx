    ...
    <div className="w-full bg-[#0A0E1A] text-[#E0F0E8] font-['JetBrains_Mono',system-ui,sans-serif] px-6 py-8 flex flex-col items-center">
      ...
      >
        ...
        <div
          ...
          className="box-border w-full h-fit shrink-0 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-[16px] justify-start items-start"
        >
          {/* 前端開發 */}
          <div
            onClick={() => handleCategoryClick("前端開發")}
            data-pencil-name="前端開發"
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#00FFFF] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              ...
              className="box-border w-[28px] h-[28px] shrink-0"
            >
              <path
          ...
          <div
            ...
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#39FF14] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              data-pencil-name="Category Icon"
              viewBox="0 0 14 14"
          ...
          <div
            ...
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#FF00FF] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              data-pencil-name="Category Icon"
              viewBox="0 0 14 14"
          ...
          <div
            ...
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#FFD700] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              data-pencil-name="Category Icon"
              viewBox="0 0 14 14"
          ...
          <div
            ...
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#FF8C00] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              data-pencil-name="Category Icon"
              viewBox="0 0 14 14"
          ...
          <div
            ...
            className="box-border w-full h-fit flex flex-col gap-[10px] p-[16px_14px] justify-start items-center bg-[#111827] border border-[#FF3366] rounded-[12px] cursor-pointer hover:bg-[#111827]/80 hover:scale-[1.02] active:scale-95 transition-all"
          >
            <svg
              data-pencil-name="Category Icon"
              viewBox="0 0 14 14"
